                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        @can('isMine',$user)
                                            ...
                                            <div class="col-auto">
                                                <!-- Button -->
                                                <a href="{{route ('homearticle.create')}}" class="btn btn-sm btn-primary">
                                                    发表文章
                                                </a>
                                                        ...
                                                        <p class="card-text small mb-1">
                                                            ...
                                                            <a href="#" class="text-secondary ml-2">
                                                                <i class="fa fa-folder-o"
                                                                   aria-hidden="true"></i> {{$article->user->name}}
                                                                于{{$article->created_at->diffForHumans()}}创作</a>
