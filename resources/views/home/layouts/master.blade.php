                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col ml--2">
                                                ...
                                                <div class="small text-muted">
                                                    <strong class="text-body">{{$notification['data']['user_name']}}</strong> <strong class="text-body">评论了</strong> <strong class="text-body">{{$notification['data']['article_title']}}</strong> <strong class="text-body"></strong>.
                                                </div>
